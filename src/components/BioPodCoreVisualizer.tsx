        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            ...
            <div className="relative z-10 flex items-center justify-between pb-3 border-b border-[#2C362F] mb-4">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-1 rounded bg-[#0B4D20] text-[#69B82F] text-xs font-mono font-bold tracking-widest border border-[#0F602B]">
                  BIOPOD HARDWARE CORE
                </span>
                <span className="text-xs sm:text-sm font-mono text-[#8C9A8F] font-semibold">SERIAL #BP-2026-X9</span>
              </div>
              <div className="text-xs sm:text-sm font-mono font-bold text-[#69B82F] flex items-center gap-1.5">
            ...
            <div className="relative z-10 flex flex-col items-center gap-3 w-full py-1">
              ...
              <div className="flex items-center gap-2 text-xs sm:text-sm font-mono font-bold text-[#42B9D9] bg-[#0E201B] px-3.5 py-1.5 rounded-full border border-[#16382C]">
              ...
              <div
                ...
                className="w-full max-w-sm bg-[#1F2621] hover:bg-[#263029] transition-all rounded-lg border border-[#344237] p-3 flex items-center justify-between cursor-pointer group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-mono font-bold text-white flex items-center gap-1.5">
                      INTAKE FAN
                      <span className="text-xs font-semibold text-[#42B9D9] bg-[#0E242C] px-2 py-0.5 rounded">
                        {effectiveFanSpeed}% SPEED
                      </span>
                    </div>
                    <div className="text-xs font-mono text-[#8C9A8F]">
                      {currentPoint.fanRpm} RPM • Brushless DC Motor
                    </div>
                  </div>
                </div>

                <span className="text-xs font-mono font-bold text-[#69B82F] bg-[#122B18] px-2.5 py-1 rounded border border-[#1E4D27]">
              ...
              <div className="flex justify-center text-[#42B9D9] opacity-70">
                <span className="text-sm font-mono font-bold animate-flow-down">↓↓↓</span>
              </div>
              ...
              <div
                ...
                onMouseLeave={() => setActiveHoverComponent(null)}
                className="w-full max-w-sm bg-[#1F2621] hover:bg-[#263029] transition-all rounded-lg border border-[#344237] p-3 flex items-center justify-between cursor-pointer"
              >
                <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-mono font-bold text-[#69B82F]">ACTIVE (94%)</span>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-mono font-bold text-white flex items-center gap-1.5">
                      HEPA H13 FILTER
                      <span className="text-xs font-bold text-[#42B9D9]">99.97%</span>
                    </div>
                    <div className="text-xs font-mono text-[#8C9A8F]">
                ...
                <span className="text-xs font-mono font-bold text-[#69B82F]">ACTIVE</span>
              </div>

              {/* Airflow Connector Arrow - Split into Dual Tanks */}
              <div className="flex items-center justify-center w-full max-w-sm text-[#69B82F] opacity-80 gap-16 font-bold">
                <span className="text-xs sm:text-sm font-mono">↙ SPARGING</span>
                <span className="text-xs sm:text-sm font-mono">SPARGING ↘</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 w-full max-w-sm">
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center justify-between mb-1.5">
                    <span className="text-xs font-mono font-bold text-[#FAF8F2] flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#69B82F]"></span>
                      ALGAE TANK 01
                    </span>
                    <Maximize2 className="w-3.5 h-3.5 text-[#69B82F] opacity-60 group-hover:opacity-100 transition-opacity" />
                  </div>

                  {/* Cylindrical visual representation with Hydrogel Label */}
                  <div className="relative z-10 rounded-lg bg-[#06170E]/85 border border-[#2B7344] p-2 overflow-hidden flex flex-col justify-between">
                    <div>
                      <div className="text-[10px] font-mono font-bold text-[#69B82F] uppercase tracking-wide bg-[#0B2E17] px-1.5 py-0.5 rounded border border-[#1E5C33] inline-block mb-1">
                        Thin Alginate Hydrogel + Algae
                      </div>
                      <div className="text-xs font-mono font-semibold text-[#A8DDA2]">
                        Chlorella vulgaris
                      </div>
                    </div>
                    ...
                    <div className="mt-1.5">
                      <div className="flex items-baseline justify-between">
                        ...
                        <span className="text-[10px] font-mono font-bold text-[#42B9D9] bg-[#0E242C] px-1.5 py-0.5 rounded">
                          Fine Bubbles
                        </span>
                      </div>
                      {/* Algae fluid fill level */}
                      <div className="w-full bg-[#0E2818] h-1.5 rounded-full mt-1.5 overflow-hidden">
                        <div
